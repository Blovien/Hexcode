...
public class ConjureZoneComponent implements Component<EntityStore> {
    ...
    private List<String> nextGlyphs;
    private Integer entityOutputSlot;
    private Integer conjurationOutputSlot;
    ...
    public ConjureZoneComponent(Vector3d halfExtents, float interval, float remainingLifetime,
            HexContext hexContext, List<String> nextGlyphs,
            @Nullable Integer entityOutputSlot, @Nullable Integer conjurationOutputSlot,
            Ref<EntityStore> hexEntityRef, Glyph sourceGlyph) {
        ...
        this.nextGlyphs = nextGlyphs;
        this.entityOutputSlot = entityOutputSlot;
        this.conjurationOutputSlot = conjurationOutputSlot;
    ...
    public List<String> getNextGlyphs() {
        return nextGlyphs;
    }

    @Nullable
    public Integer getEntityOutputSlot() {
        return entityOutputSlot;
    }

    @Nullable
    public Integer getConjurationOutputSlot() {
        return conjurationOutputSlot;
    }
    ...
    public ConjureZoneComponent clone() {
        ...
        copy.nextGlyphs = this.nextGlyphs;
        copy.entityOutputSlot = this.entityOutputSlot;
        copy.conjurationOutputSlot = this.conjurationOutputSlot;
