package com.riprod.hexcode.builtin.glyphs.effect.ensnare.system;
...
public class EnsnareTickSystem extends EntityTickingSystem<EntityStore> {
    ...
    public Query<EntityStore> getQuery() {
        return EnsnareComponent.getComponentType();
    }
    ...
    public void tick(float dt, int index, ArchetypeChunk<EntityStore> chunk,
        ...
        try {
            EnsnareComponent rupture = chunk.getComponent(index, EnsnareComponent.getComponentType());
            ...
            LOGGER.atSevere().log("[hexcode] EnsnareTickSystem failed: %s", e.getMessage());
        }
    }

    private void processDamage(EnsnareComponent rupture, CommandBuffer<EntityStore> buffer) {
    ...
    private void removeSpikes(EnsnareComponent rupture, CommandBuffer<EntityStore> buffer) {
