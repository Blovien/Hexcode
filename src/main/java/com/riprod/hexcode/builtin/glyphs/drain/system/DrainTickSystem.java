package com.riprod.hexcode.builtin.glyphs.drain.system;
...
import com.riprod.hexcode.builtin.glyphs.drain.component.DrainComponent.DrainEntry;
...
public class DrainTickSystem extends EntityTickingSystem<EntityStore> {
    ...
    private void completeEntry(DrainEntry entry, Ref<EntityStore> targetRef,
        ...
        if (ctx != null) {
            ...
            HexExecuter.continueExecution(entry.getNextGlyphIds(), ctx);
        }
    }
