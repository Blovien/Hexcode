...
public class ScaleGlyph implements GlyphHandler {
    ...
    public static final String ID = "Glyph_Scale";
    public static final String HANDLER_ID = "scale";
    private static final String MODEL_ID = "Glyph_Scale";
        ...
        try {
            ...
            if (existingMarker != null) {
                ...
                if (existingConstruct != null && existingConstruct.isValid()) {
                    HexConstruct existingHc = accessor.getComponent(
                            existingConstruct, HexConstruct.getComponentType());
                    if (existingHc != null) {
