...
public class Hexcode extends JavaPlugin {
    ...
    protected void setup() {
        ...
        ComponentType<EntityStore, HexcasterCraftingComponent> craftingRootComponentType = entityStoreRegistry
                .registerComponent(HexcasterCraftingComponent.class, "HexcasterCrafting",
                        HexcasterCraftingComponent.CODEC);
        ...
        ComponentType<EntityStore, HexcodeSessionComponent> sessionComponentType = entityStoreRegistry
                .registerComponent(HexcodeSessionComponent.class,
                        HexcodeSessionComponent::new);
        ...
        this.getEventRegistry().registerGlobal(PlayerConnectEvent.class, SessionLifecycleHandler::onPlayerConnect);
